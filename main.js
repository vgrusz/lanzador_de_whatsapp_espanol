function lanzar() {
    ...
    let url =
      "https://api.whats"+"app.com/send/?phone=" +
      prefijoNacional +
      telefonoSinEspacios +
      "&text=" +
  ...
  function appLoad() {
    document.getElementById("prefijoNacional").value =
      localStorage.getItem("prefijoNacional");
    document.getElementById("primerTextoConstante").value =
      localStorage.getItem("primerTextoConstante");
    document.getElementById("segundoTextoConstante").value =
      localStorage.getItem("segundoTextoConstante");
    document.getElementById("ultimoTextoConstante").value =
      localStorage.getItem("ultimoTextoConstante");
  }
